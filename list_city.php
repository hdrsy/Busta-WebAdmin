        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['City_List_Management'];?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
							...
							<th><?php echo $lang['City_Name'];?></th>
												...
												<th><?php echo $lang['City_Status'];?></th>
												<th><?php echo $lang['Action'];?></th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $h->select("tbl_city");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_city.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
