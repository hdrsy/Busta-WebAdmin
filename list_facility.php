        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Facility_List_Management'];?></h3>
                </div>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
							...
							<th><?php echo $lang['Facility_Name'];?></th>
											<th><?php echo $lang['Facility_Image'];?></th>
												<th><?php echo $lang['Facility_Status'];?></th>
												<th><?php echo $lang['Action'];?></th>
                          </tr>
                        </thead>
                        <tbody>
                           <?php 
										$city = $h->select("tbl_facility");
										$i=0;
