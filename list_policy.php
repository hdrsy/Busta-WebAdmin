        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Cancellation_Policy_List_Management'];?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
										...
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_policy.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
