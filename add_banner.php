        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Banner_Management'];?></h3>
                </div>
           ...
           <div class="col-sm-12">
                <div class="card">
				 ...
				 if(isset($_GET['id']))
				 {
					 ...
					 $query = "select * from tbl_banner where id=".$_GET['id'];
		  $data = $h->fetchData($query);
					 ...
					 <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
										...
										<input type="hidden" name="id" value="<?php echo $_GET['id'];?>"/>
										 ...
										 <div class="form-group mb-3">
                                            <label><?php echo $lang['Banner_Status'];?></label>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Edit_Banner'];?></button>
                                    </div>
                                </form>
					 <?php 
				 }
				 ...
				 ?>
                  <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Add_Banner'];?></button>
                                    </div>
                                </form>
				 <?php } ?>
                </div>
