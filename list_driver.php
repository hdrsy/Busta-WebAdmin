        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Driver_List_Management'];?></h3>
                </div>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
											...
											<th><?php echo $lang['Driver_Email'];?></th>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $h->queryfire("select * from tbl_driver where operator_id=".$sdata["id"]."");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
                                               ...
                                               <td>
                                                ...
                                                <td><span class="badge badge-success"><?php echo $lang['Active'];?></span></td>
												<?php } else { ?>
												
												<td>
												<span class="badge badge-danger"><?php echo $lang['Deactive'];?></span></td>
												<?php } ?>
                                                <td style="white-space: nowrap; width: 15%;"><div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                           <div class="btn-group btn-group-sm" style="float: none;">
										   <a href="add_driver.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
