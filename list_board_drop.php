        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Board_Drop_Up_Point_List_Management'];?></h3>
                </div>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
											...
											<th><?php echo $lang['Bus_Total_Routes'];?></th>
                                        ...
                                        <tbody>
                                           <?php 
										$city = $h->queryfire("SELECT bus_id, COUNT(*) as total_routes
...
where operator_id=".$sdata['id']." GROUP BY bus_id");
										...
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<td>
                                                   <?php $data = $h->queryfire("select * from tbl_bus where id=".$row["bus_id"]."")->fetch_assoc(); echo $data['title']; ?>
                                                </td>
                                                
                                               <td>
                                                    <?php $totalRoutes = $row['total_routes'];
    echo $totalRoutes . ' ' . ($totalRoutes === 1 ? 'Route' : 'Routes'); ?>
                                                </td>
										   ...
										   <a href="add_board_drop.php?id=<?php echo $row['bus_id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
