...
?>
   ...
   <?php require 'inc/Footer.php'; ?>
	...
	<script>
	<?php
function fetchDataAndEncode($variableName, $type, $year, $bus, $dateColumn, $tblname,$operator_id)
{
    $vname = $variableName;
...
echo fetchDataAndEncode('bookData', '', $year, $bus, 'book_date', 'tbl_book',$sdata["id"]);
