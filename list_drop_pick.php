...
$query = "select * from tbl_city where id=".$row["city_id"];
		  $data = $h->fetchData($query);
										   ...
										   <a href="add_drop_pick.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><?xml version="1.0" encoding="UTF-8"?>
